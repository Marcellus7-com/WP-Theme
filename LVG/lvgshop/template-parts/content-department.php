...
<div class="col-lg-4 lvgshop-team-block-d">
    
     <div class="text-center lvgshop-expert-doctors-position ex-doctor-style-one">
                                                            <div class="lvgshop-expert-doctors-1st m-lg-2 m-2 text-center lvgshop-bg-style">
                                                                <h2 class="lvgshop-global-h-md medical-treatment-name-h2 "><a href="<?php the_permalink(); ?>"><?php the_title(); ?>
                                                                    </a></h2>
