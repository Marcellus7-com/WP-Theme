...
$sticky_header_content = $lvgshop_options['sticky_header_content'];
$sticky_btn_text = $lvgshop_options['sticky_button_text'];
$sticky_btn_url = $lvgshop_options['sticky_button_url'];
$ntbgtype =  $lvgshop_options['sticky_bar_style'];
$notification_btn_target =  $lvgshop_options['button_target'];
