...
<div class="col mb-4">
    ...
    <?php if ($product_style == "style-one") { ?>
        ...
        <?php get_template_part('inc/vendor/woocommerce/product-style/product-style-one'); ?>
    ...
    <?php } elseif ($product_style == "style-five") { ?>
        ...
        <?php get_template_part('inc/vendor/woocommerce/product-style/product-style-five'); ?>
