...
array(
            ...
            'local_import_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home01/sitecontents.xml',
            'local_import_widget_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home01/widgets.wie',
            'local_import_csf' => array(
                array(
                    'file_path' => trailingslashit(get_template_directory()) . 'inc/admin/import/home01/themeoptions.json',
                    'option_name' => 'lvgshop_options',
                ),
            ),
            'import_preview_image_url' => LVGSHOP_URL .'/assets/images/demos/1.jpg',
            'preview_url' => 'https://ia.marcellus7.com/lvgshop-maindemo/',
            'import_notice' => __
        ...
        array(
            ...
            'categories' => array('Elementor'),
            'local_import_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home02/sitecontents.xml',
            'local_import_widget_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home02/widgets.wie',
            'local_import_csf' => array(
                array(
                    'file_path' => trailingslashit(get_template_directory()) . 'inc/admin/import/home02/themeoptions.json',
                    'option_name' => 'lvgshop_options',
                ),
            ),
            'import_preview_image_url' => LVGSHOP_URL .'/assets/images/demos/2.jpg',
            'preview_url' => 'https://ia.marcellus7.com/lvgshop-maindemo/',
            'import_notice' => __
            ('Before Setup Demo Please Install All Plugin Requireds.Intall Elementor as Page Builder.For Import You Need to wait 3-5 Mintues.', '@@textdomain'),
        ),
         ...
         array(
            ...
            'categories' => array('Elementor'),
            'local_import_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home03/sitecontents.xml',
            'local_import_widget_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home03/widgets.wie',
            'local_import_csf' => array(
                array(
                    'file_path' => trailingslashit(get_template_directory()) . 'inc/admin/import/home03/themeoptions.json',
                    'option_name' => 'lvgshop_options',
                ),
            ),
            'import_preview_image_url' => LVGSHOP_URL .'/assets/images/demos/3.jpg',
            'preview_url' => 'https://ia.marcellus7.com/lvgshop-maindemo/',
            'import_notice' => __
            ('Before Setup Demo Please Install All Plugin Requireds.Intall Elementor as Page Builder.For Import You Need to wait 3-5 Mintues.', '@@textdomain'),
        ),
