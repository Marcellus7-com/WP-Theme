...
if ( ! function_exists( 'lvgshop_woo_sidebar_prone' ) ) {
	function lvgshop_woo_sidebar_prone() { 
	global $post , $product;
            ...
            <div class="pivo-product-img col-12 col-md-4 ">
              <div class="position-relative">
                <a href="<?php the_permalink();?>"> <?php if ( has_post_thumbnail() ) {
					the_post_thumbnail('lvgshop-woo-sidebar-alt');
				} ?></a>
...
$product );
            ...
            <div class="lvgshop-rcp-product-info col-12 col-md-8">
