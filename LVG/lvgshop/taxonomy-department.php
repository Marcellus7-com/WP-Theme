...
<!-- LVG Shop by M7 Hero Start -->
                                <div id="lvgshop-hero-banner">
                                    <div class="row lvgshop-hero-banner">
                                         <div class="lvgshop-single-post-breadcumb text-center">
                                           <?php lvgshop_breadcrumbs();?>
                                         </div>
                                       <?php
                                      
					the_archive_title( '<h1 class="page-title lvgshop-heading text-center">', '</h1>' );
...
<section class="lvgshop-page-main-content lvgshop-archive-main-content">
