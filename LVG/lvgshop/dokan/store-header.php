...
$store_open_notice        = isset( $store_info['dokan_store_open_notice'] ) && ! empty( $store_info['dokan_store_open_notice'] ) ? $store_info['dokan_store_open_notice'] : __( 'Store Open', 'lvgshop' );
$store_closed_notice      = isset( $store_info['dokan_store_close_notice'] ) && ! empty( $store_info['dokan_store_close_notice'] ) ? $store_info['dokan_store_close_notice'] : __( 'Store Closed', 'lvgshop' );
...
<section class="container lvgshop-extended-container lvgshop-dokan-custom-header">
            
            <?php if ( $store_user->get_banner() ) { ?>
    <div class="lvgshop-common-breadcrumbs lvgshop-dokan-sotre-header" style="background:url( <?php echo esc_url( $store_user->get_banner() ); ?>);">
        <?php } else { ?>
        <div class="lvgshop-common-breadcrumbs ">
        <?php } ?>
