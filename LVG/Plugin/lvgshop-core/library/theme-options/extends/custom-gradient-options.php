 ...
 *
 */
if ( ! class_exists( 'CSF_Field_lvgshop_gradient' ) ) {
  class CSF_Field_lvgshop_gradient extends CSF_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="csf-color lvgshopgradient-'.$this->field['id'].'"'. $default_attr . $this->field_attributes() .'/>';
      echo $this->field_after();
      
      ?>
<script>
jQuery(document).ready(function($){
    $('.lvgshopgradient-<?php echo $this->field['id'];?>').coloringPick({
	'show_input': false,
	'theme': 'dark',
