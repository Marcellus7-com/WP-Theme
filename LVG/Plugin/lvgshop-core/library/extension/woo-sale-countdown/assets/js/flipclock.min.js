...
(function ($, window, document, undefined) {
    ...
    $.extend(CountDown.prototype, {
        ...
        markup: function () {
            ...
            var html = [
                '<span class="lvgshop-count-value item item-dd">',
                    '<span class="dd text-main-color"></span><br>',
                    '<span class="label label-dd fs-sm">', this.options.label_dd, '</span>',
                '</span>',

                '<span class="lvgshop-count-value item item-hh">',
                    '<span class="hh-1 text-main-color"></span>',
                    '<span class="hh-2 text-main-color"></span><br>',
                    '<span class="label label-hh fs-sm">', this.options.label_hh, '</span>',
                '</span>',

                '<span class="lvgshop-count-value item item-mm">',
                    '<span class="mm-1 text-main-color"></span>',
                    '<span class="mm-2 text-main-color"></span><br>',
                    '<span class="label label-mm fs-sm">', this.options.label_mm, '</span>',
                '</span>',

                '<span class="lvgshop-count-value item item-ss">',
                    '<span class="ss-1 text-main-color"></span>',
                    '<span class="ss-2 text-main-color"></span><br>',
                    '<span class="label label-ss fs-sm">', this.options.label_ss, '</span>',
                '</span>'
            ];
