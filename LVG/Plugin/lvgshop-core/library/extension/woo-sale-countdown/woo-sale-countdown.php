...
if (!class_exists('XPSC_Woo_Sale_Countdown')) :
    ...
    define('XPSC_DOMAIN', 'lvgshop-core');
    ...
    class XPSC_Woo_Sale_Countdown
    {
        ...
        public function frontend_enqueue_global() {
            ...
            wp_localize_script(
                ...
                array(
                    ...
                    'endDate' => $this->is_sale_valid && $this->get_product_sale_time('to', 'front') ? strtotime($this->get_product_sale_time('to', 'front'), current_time('timestamp', false)) : null,
                )
            );
        ...
        public function setup_actions() {
            ...
            add_action('woocommerce_single_product_style_three_sale_countdown', array($this, 'sale_countdown'));
            ...
            if ($sales_price_to) {
                ...
                <div class="xpsc-product-coutdown-wrapper">
                    ...
                    if ($this->is_sale_valid) :
                        ?>
                        <h5 class="lvgshop-sale-countdown-title"><?php echo esc_html(cs_get_option('countdown_ttl')); ?></h5>
                        <?php
        ...
        private function countdown_html() {
            ...
            <div class="lvgshop-timer-for-countdown lvgshop-timer-<?php echo cs_get_option('count_style'); ?> <?php echo cs_get_option('sdw_enable'); ?>">
                <div id="lvgshoptimer">
                    <?php echo $sale_to_date; ?>
                </div>
            </div>
