...
class Settings {
	const OPTION_NAME = 'lvgshop_variaiton_swatches';
	 ...
	 * @static
	 *
	 * @return Lvgshop\VariationSwatches\Admin\Settings An instance of the class.
	 */
	...
	public function get_shape_options() {
		$options = apply_filters( 'lvgshop_variation_swatches_shape_options', [
			'round'   => esc_html__( 'Round', 'lvgshop-variation-swatches' ),
			'rounded' => esc_html__( 'Rounded', 'lvgshop-variation-swatches' ),
			'square'  => esc_html__( 'Square', 'lvgshop-variation-swatches' ),
		] );
		...
		if ( current_theme_supports( 'woocommerce' ) ) {
			...
			if ( $theme_style ) {
				$options = array_merge( [ 'default' => esc_html__( 'Theme Default', 'lvgshop-variation-swatches' ) ], $options );
			}
		}
