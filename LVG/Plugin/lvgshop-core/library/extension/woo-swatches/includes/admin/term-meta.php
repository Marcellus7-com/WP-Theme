...
class Term_Meta {
	 ...
	 * @static
	 *
	 * @var Lvgshop\VariationSwatches\Admin\Term_Meta
	 */
	 ...
	 * @static
	 *
	 * @return Lvgshop\VariationSwatches\Admin\Term_Meta An instance of the class.
	 */
	...
	public function get_swatches_types() {
		return [
			'color'  => esc_html__( 'Color', 'lvgshop-variation-swatches' ),
			'image'  => esc_html__( 'Image', 'lvgshop-variation-swatches' ),
			'label'  => esc_html__( 'Label', 'lvgshop-variation-swatches' ),
			'button' => esc_html__( 'Button', 'lvgshop-variation-swatches' ),
		];
	}
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( 'lvgshop-variation-swataches-term', plugins_url( '/assets/css/admin.css', LVGSHOP_VARIATION_SWATCHES_FILE ), [ 'wp-color-picker' ], '20210630' );
		wp_enqueue_script( 'lvgshop-variation-swataches-term', plugins_url( '/assets/js/admin.js', LVGSHOP_VARIATION_SWATCHES_FILE ), [ 'jquery', 'wp-color-picker', 'wp-util', 'jquery-serialize-object' ], '20210630', true );
	}
	...
	public function add_attribute_fields( $taxonomy ) {
		...
		<div class="form-field term-swatches-wrap">
			...
			<p class="description"><?php esc_html_e( 'This data will be used for variation swatches of variable products.', 'lvgshop-variation-swatches' ) ?></p>
		</div>
	...
	public function field_label( $type ) {
		$labels = [
			'color'  => esc_html__( 'Swatches Color', 'lvgshop-variation-swatches' ),
			'image'  => esc_html__( 'Swatches Image', 'lvgshop-variation-swatches' ),
			'label'  => esc_html__( 'Swatches Label', 'lvgshop-variation-swatches' ),
		];
	...
	public function field_input( $type, $term = null ) {
		...
		switch ( $type ) {
			case 'image':
				...
				?>
				<div class="lvgshop-variation-swatches__field-image">
					...
					<p class="hide-if-no-js">
						<a href="#"
							...
							aria-label="<?php esc_attr_e( 'Swatches Image', 'lvgshop-variation-swatches' ) ?>"
							data-choose="<?php esc_attr_e( 'Use image', 'lvgshop-variation-swatches' ) ?>"
						>
							<?php esc_html_e( 'Upload', 'lvgshop-variation-swatches' ); ?>
						</a>
						<a href="#" class="button button-link button-remove-image <?php echo ! $value ? 'hidden' : '' ?>"><?php esc_html_e( 'Remove', 'lvgshop-variation-swatches' ) ?></a>
					</p>
			...
			case 'color':
				?>
				<p class="lvgshop-variation-swatches__field-color">
			...
			case 'label':
				?>
				<p class="lvgshop-variation-swatches__field-label">
	...
	protected function field_name( $type ) {
		return 'lvgshop_variation_swatches_' . $type;
	}
	...
	public function add_attribute_column_content( $columns, $column, $term_id ) {
		...
		switch ( $attr->attribute_type ) {
			case 'color':
				printf( '<div class="lvgshop-variation-swatches__thumbnail lvgshop-variation-swatches--color" style="background-color:%s;"></div>', esc_attr( $value ) );
				break;

			case 'image':
				$image = $value ? wp_get_attachment_image_url( $value ) : false;
				$image = $image ? $image : wc_placeholder_img_src( 'thumbnail' );
				printf( '<img class="lvgshop-variation-swatches__thumbnail lvgshop-variation-swatches--image" src="%s" width="40px" height="40px">', esc_url( $image ) );
				break;

			case 'label':
				printf( '<div class="lvgshop-variation-swatches__thumbnail lvgshop-variation-swatches--label">%s</div>', esc_html( $value ) );
				break;
		}
	}
