...
add_shortcode( 'lvgshop_woo_register', 'lvgshop_separate_registration_form' );
    
function lvgshop_separate_registration_form() {
   if ( is_admin() ) return;
   ...
   ?>
      <form method="post" class="lvgshop-register-form woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
 ...
 <?php 
   ...
   ?>
   <?php if ($logpage){ ?>
    <a href="<?php echo esc_attr( esc_url( get_page_link( $logpage ) ) ) ?>" class="nikstore_register_link"><?php esc_attr_e('Already have an account? Log in','lvgshop');?></a>
    <?php } ?>
</div>
