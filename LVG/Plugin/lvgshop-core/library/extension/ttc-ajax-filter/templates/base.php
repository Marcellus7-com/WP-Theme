...
$filter_title = $attributes['titlecontent'];
$filteralign = $attributes['filteralign'];
$filterebl = cs_get_option('filter_item_disable_mb');
?>
    <section
            class="js-container-async ajax-posts el-popular-product-section"
    ...
    >
        ...
        <?php if ($filterebl) { ?>
            <div class="anc-ajax-filter-box--m <?php echo esc_html($filteralign); ?>">
                <?php if ($filter_title) { ?>
                    <h2 class="ajax_epc_section_title text-capitalize font-semibold wow fadeInUp"><?php echo esc_html($filter_title); ?></h2>
                <?php } ?>
        ...
        <div class="ajax-posts__view">
            ...
            <div class="ajax-posts__posts row row-cols-12 row-cols-md-2 row-cols-lg-<?php echo $attributes['column'] ?>">
