jQuery(window).on("elementor/frontend/init", () => {
    function d(o, t, i, d = !1, e = !1, l = [], r = !1) {
        let a = lvgshop_elementor_object.lvgshop_shapes,
            _ = "lvgshop-divider ",
            s =
                (0 == r && (r = !1),
                (_ += " position-absolute lvgshop-divider-in-elementor "),
                (container_style = ""),
                (container_style = "top" == i ? ((_ += "lvgshop-top-divider"), 'style="top:-1px;"') : ((_ += "lvgshop-bottom-divider"), 'style="bottom:-1px;"')),
                l.d_high_index && (_ += " lvgshop-divider-in-front"),
                l.d_flip_h && (_ += " lvgshop-divider-flip-h"),
        ...
        if (((output = '<div class="' + _ + '" data-style="style-' + o + '" ' + container_style + ">"), "dynamic" == l.d_divider_select)) {
            ...
            (dynamic = '<div class="lvgshop-dividers-box" ' + _ + ">"),
                (dynamic = (dynamic = (dynamic += '<svg class="lvgshop-shape-dividers" ' + _ + ' viewBox="0 0 100 100" preserveAspectRatio="none">') + ("<defs>" + c + "</defs>" + p)) + "</svg>" + "</div>"),
                (output += dynamic);
        } else output += s;
        return (output += "</div>");
    }
    var _ = (_) => {
        ...
        if (void 0 !== i && !1 !== i) {
            ...
            var i = Math.floor(1e5 * Math.random()),
                o = t.lvgshop_sticky_top;
            if (
                (o &&
                    "true" === o &&
                    ((o = 20),
                    0 < $(".lvgshop-enable-sticky, .lvgshop-is-sticky-header").length && ((o = $(".lvgshop-header").height()), 0 < $("#masthead").length && ($("#masthead").hasClass("lvgshop-header-box") ? (o += 20) : (o += 10))),
                    _.addClass("sticky-top lvgshop-sticky-top-adjust"),
                    _.css({ top: o })),
            ...
            (o ? _.find("> .elementor-column-wrap > .lvgshop-divider") : _.find("> .lvgshop-divider")).remove(),
                e &&
                    "" !== e &&
                    ((o ? _.find("> .elementor-column-wrap") : _).prepend(e),
                    
                    _.find(".lvgshop-shape-dividers").each(function () {
