 ...
 * @since 1.0.0
 */
class Lvgshop_Icon_List extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Lvgshop Menu Icon List', 'elementor' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => esc_html__( 'hot', 'elementor' ),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$repeater->add_control(
			'label_bg',
			[
				'label' => esc_html__( 'Label Bg Color', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .item_label' => 'background: {{VALUE}}',
				],
			]
		);
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .item_label' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .lvgshop-menu-icon-list-items:not(.elementor-inline-items) .lvgshop-menu-icon-list-item:not(:last-child)' => 'padding-bottom: calc({{SIZE}}{{UNIT}}/2)',
					'{{WRAPPER}} .lvgshop-menu-icon-list-items:not(.elementor-inline-items) .lvgshop-menu-icon-list-item:not(:first-child)' => 'margin-top: calc({{SIZE}}{{UNIT}}/2)',
					'{{WRAPPER}} .lvgshop-menu-icon-list-items.elementor-inline-items .lvgshop-menu-icon-list-item' => 'margin-right: calc({{SIZE}}{{UNIT}}/2); margin-left: calc({{SIZE}}{{UNIT}}/2)',
					'{{WRAPPER}} .lvgshop-menu-icon-list-items.elementor-inline-items' => 'margin-right: calc(-{{SIZE}}{{UNIT}}/2); margin-left: calc(-{{SIZE}}{{UNIT}}/2)',
					'body.rtl {{WRAPPER}} .lvgshop-menu-icon-list-items.elementor-inline-items .lvgshop-menu-icon-list-item:after' => 'left: calc(-{{SIZE}}{{UNIT}}/2)',
					'body:not(.rtl) {{WRAPPER}} .lvgshop-menu-icon-list-items.elementor-inline-items .lvgshop-menu-icon-list-item:after' => 'right: calc(-{{SIZE}}{{UNIT}}/2)',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .lvgshop-menu-icon-list-item:not(:last-child):after' => 'content: ""',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .lvgshop-menu-icon-list-items:not(.elementor-inline-items) .lvgshop-menu-icon-list-item:not(:last-child):after' => 'border-top-style: {{VALUE}}',
					'{{WRAPPER}} .lvgshop-menu-icon-list-items.elementor-inline-items .lvgshop-menu-icon-list-item:not(:last-child):after' => 'border-left-style: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .lvgshop-menu-icon-list-items:not(.elementor-inline-items) .lvgshop-menu-icon-list-item:not(:last-child):after' => 'border-top-width: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .elementor-inline-items .lvgshop-menu-icon-list-item:not(:last-child):after' => 'border-left-width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .lvgshop-menu-icon-list-item:not(:last-child):after' => 'width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .lvgshop-menu-icon-list-item:not(:last-child):after' => 'height: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .lvgshop-menu-icon-list-item:not(:last-child):after' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .lvgshop-menu-icon-list-item:hover .elementor-icon-list-icon i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .lvgshop-menu-icon-list-item:hover .elementor-icon-list-icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .lvgshop-menu-icon-list-item:hover .elementor-icon-list-text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .lvgshop-menu-icon-list-item > .elementor-icon-list-text, {{WRAPPER}} .lvgshop-menu-icon-list-item > a',
				'global' => [
	...
	protected function render() {
		...
		$this->add_render_attribute( 'icon_list', 'class', 'lvgshop-menu-icon-list-items' );
		$this->add_render_attribute( 'list_item', 'class', 'lvgshop-menu-icon-list-item' );
		...
		<ul <?php $this->print_render_attribute_string( 'icon_list' ); ?>>
			...
			foreach ( $settings['icon_list'] as $index => $item ) :
				...
				<li <?php $this->print_render_attribute_string( 'list_item' ); ?>>
				    <span class="elementor-repeater-item-<?php echo esc_attr( $item['_id'] ) ?>">
					<?php
	...
	protected function content_template() {
		?>
		<#
			view.addRenderAttribute( 'icon_list', 'class', 'lvgshop-menu-icon-list-items' );
			view.addRenderAttribute( 'list_item', 'class', 'lvgshop-menu-icon-list-item' );
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Lvgshop_Icon_List() );