 ...
 * @since 1.0.0
 */
class Lvgshop_Widget_Icon_List extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Menu Icon List', 'elementor' );
	}
...
\Elementor\Plugin::instance()->widgets_manager->register(new \Lvgshop_Widget_Icon_List());
?>