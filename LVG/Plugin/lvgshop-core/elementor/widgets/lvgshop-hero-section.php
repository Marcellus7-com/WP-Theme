...
class lvgshop_hero_section extends \Elementor\Widget_Base
{

    public function get_name() {
        return 'lvgshop-hero-section';
    }

    public function get_title() {
        return esc_html__('Lvgshop Hero Section', 'lvgshop-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'Button-One-style',
            [
                'label' => esc_html__('Button One Style', 'lvgshop-core'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            'Button-style-two',
            [
                'label' => esc_html__('Button Two Style', 'lvgshop-core'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
                    'Widget-Style' => 'style_1',
                ],
    ...
    protected function render() {
        ...
        if ('style_1' == $settings['Widget-Style']) {
            lvgshop_hero_style_1($settings);
        } else {
            lvgshop_hero_style_2($settings);
        }
    }

}

\Elementor\Plugin::instance()->widgets_manager->register(new \lvgshop_hero_section());
