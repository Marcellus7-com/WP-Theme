...
{
    for ($i = 0; $i < $rating; $i++) {
        $rst = '<i class="fa-solid fa-star ratings-icon"></i>';
        echo $rst;
    }
}

if (!function_exists('lvgshop_client_reviews_one')) {
    function lvgshop_client_reviews_one($rev_list)
    { ?>

        <div class="lvgshop-reviews-one lvgshop-review-common-class">


            <div class="lvgshop_swiper_nav_style_one">
                <div class="lvgshop-button-prev"><i class="isax icon-spcial-arrow-left"></i></div>
                <div class="lvgshop-button-next"><i class="isax icon-spcial-arrow-right"></i></div>
...
if (!function_exists('lvgshop_client_reviews_two')) {
    function lvgshop_client_reviews_two($rev_list)
    { ?>


        <div class="lvgshop-reviews-two lvgshop-review-common-class">
...
if (!function_exists('lvgshop_client_reviews_three')) {
    function lvgshop_client_reviews_three($rev_list)
    { ?>
        <div class="clearfix"></div>
        <div class="lvgshop-clreviews-three lvgshop-review-common-class">

            <div class="slide-bg-three-inner">
                <div class="saaplate--marquee__rev__container_alt lvgshop-marquee-stl3" id="lvgshop-marquee-stl3">
...
if (!function_exists('lvgshop_client_reviews_four')) {
    function lvgshop_client_reviews_four($rev_list)
    { ?>
        <div class="clearfix"></div>
        <div class="lvgshop-clreviews-four lvgshop-review-common-class">
            <div class="saaplate--marquee__rev__container_alt lvgshop-marquee-stl4" id="lvgshop-marquee-stl4">
...
if (!function_exists('lvgshop_client_reviews_five')) {
    function lvgshop_client_reviews_five($rev_list)
    { ?>

        <div class="lvgshop-reviews-five lvgshop-reviews-five lvgshop-review-common-class">
            <div class="swiper reviews-five swiper-container">
                <div class="swiper-wrapper">
                    <?php foreach ($rev_list as $rev_item) { ?>
                        <div class="swiper-slide patinets-single-review-5">
                            <div class="lvgshop-review-style-5">
                ...
                <div class="lvgshop-rev-five-bottom-content row">
                    ...
                    <div class="rev-5-navigation col-12 col-md-4">
                        ...
                        <div class="lvgshop-button-next-five"><svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                        ...
                        <div class="lvgshop-button-prev-five"><svg width="15" height="15" viewBox="0 0 15 15" fill="none">
...
if (!function_exists('lvgshop_client_reviews_six')) {
    function lvgshop_client_reviews_six($rev_list)
    { ?>
        <div class="lvgshop-reviews-six lvgshop-review-common-class">


            <div class="lvgshop_swiper_nav_style_six">
                <div class="lvgshop-button-prev"><i class="isax icon-arrow-left1"></i></div>
                <div class="lvgshop-button-next"><i class="isax icon-arrow-right1"></i></div>
...
if (!function_exists('lvgshop_client_reviews_seven')) {
    function lvgshop_client_reviews_seven($rev_list)
    { ?>

        <div class="lvgshop-reviews-seven lvgshop-reviews-seven lvgshop-review-common-class">
                ...
                <div class="swiper-wrapper">
                    <?php foreach ($rev_list as $rev_item) { ?>
                        <div class="swiper-slide patinets-single-review-5">
                            ...
                            <div class="lvgshop-rev-six-bottom-content row">

                                <div class="rev-5-navigation col-6 col-md-4">


                                    <div class="lvgshop-button-next-five"><i class="isax icon-arrow-left-11"></i></div>
                                    <div class="lvgshop-button-prev-five"><i class="isax icon-arrow-right-11"></i></div>
                                </div>
...
if (!function_exists('lvgshop_client_reviews_eight')) {
    function lvgshop_client_reviews_eight($rev_list)
    { ?>

        <div class="lvgshop-reviews-eight lvgshop-reviews-eight lvgshop-review-common-class">
                    ...
                    <?php foreach ($rev_list as $rev_item) { ?>
                        <div class="patinets-single-review-8">
                            ...
                            <div class="swp-review-top-part">
                                ...
                                <div class="lvgshop-review-style-8">
...
if (!function_exists('lvgshop_client_reviews_nine')) {
    function lvgshop_client_reviews_nine($rev_list)
    { ?>

        <div class="lvgshop-reviews-nine lvgshop-reviews-nine lvgshop-review-common-class">
...
if (!function_exists('lvgshop_client_reviews_ten')) {
    function lvgshop_client_reviews_ten($rev_list)
    { ?>

        <div class="lvgshop-reviews-ten lvgshop-reviews-ten reviews-ten-wrapper lvgshop-review-common-class">
                        ...
                        <div class="patinets-single-review-10 swiper-slide">
                            ...
                            <div class="swp-review-top-part row">
                                ...
                                <div class="review-content-ten col-12 col-md-8">
                                    ...
                                    <div class="lvgshop-review-style-ten">
...
if (!function_exists('lvgshop_client_reviews_eleven')) {
    function lvgshop_client_reviews_eleven($rev_list)
    { ?>

        <div class="lvgshop-reviews-eleven lvgshop-reviews-eleven reviews-eleven-wrapper lvgshop-review-common-class">
                        ...
                        <div class="patinets-single-review-11 swiper-slide">
                            ...
                            <div class="swp-review-top-part">
                                ...
                                <div class="review-content-eleven">
                                    ...
                                    <div class="lvgshop-review-style-eleven">
...
if (!function_exists('lvgshop_client_reviews_twelve')) {
    function lvgshop_client_reviews_twelve($rev_list)
    { ?>

        <div class="lvgshop-reviews-eleven lvgshop-reviews-twelve reviews-eleven-wrapper lvgshop-review-common-class">
            <div class="reviews-eleven">
                <div class="swiper-wrapper">
                    <?php foreach ($rev_list as $rev_item) { ?>
                        <div class="patinets-single-review-11 swiper-slide">
                            ...
                            <div class="swp-review-top-part">
                                ...
                                <div class="review-content-eleven">
                                    ...
                                    <div class="row lvgshop-review-12-contents">
                                        <div class="col-12 col-md-8">
                                            <h4><?php echo $rev_item['rev_name'];?></h4>
                                        <span class="lvgshop-rev-desg2"><?php echo $rev_item['rev_desig'];?></span>
                                        </div>
...
if (!function_exists('lvgshop_client_reviews_thirteen')) {
    function lvgshop_client_reviews_thirteen($rev_list)
    { ?>

        <div class="lvgshop-reviews-thirteen lvgshop-reviews-thirteen reviews-thirteen-wrapper lvgshop-review-common-class">
                        ...
                        <div class="patinets-single-review-11 swiper-slide">
                            ...
                            <div class="swp-review-top-part">
                                ...
                                <div class="review-content-thirteen">
                                    ...
                                    <div class="lvgshop-review-style-thirteen">
                                    ...
                                    <div class="row lvgshop-review-13-contents">
                                        <div class="col-12">
                                            <h4><?php echo $rev_item['rev_name'];?></h4>
                                        <span class="lvgshop-rev-desg2"><?php echo $rev_item['rev_desig'];?></span>
                                        </div>
